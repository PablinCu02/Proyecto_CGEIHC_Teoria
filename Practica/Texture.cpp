...
bool Texture::LoadTextureA()
{
	...
	/*	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_MIRRORED_REPEAT); // eje S paralelo a X, repetir sobre el eje pero rotando conforme a un centro
	...
	*/
	...
	/* GL_TEXTURE_MIN_FILTER: Para cuando el fragmento está más cerca y la textura se escala a menor tamaño.
	   GL_TEXTURE_MAG_FILTER: Para cuando el fragmento está más lejos y la textura se escala a mayor tamaño.
	   GL_LINEAR aplica sampling y blending de los texels más cercanos. GL_NEAREST aplica sample del texel más cercano.
	*/
...
{	// Unidad de textura
	...
	// si hay más de 1 unidad de textura se tiene que crear una variable uniforme que haga cambio entre la unidad de textura a utilizar
